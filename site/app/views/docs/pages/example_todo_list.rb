...
module Views
  module Docs
    module Pages
      class ExampleTodoList < Views::Docs::Page
        ...
        def model
          render Views::Docs::Section.new('Model') do
        ...
        def row
          render Views::Docs::Section.new('One row (record-backed, all the actions)') do
            render Views::Code.new(<<~RUBY, lexer: :ruby)
        ...
        def list
          render Views::Docs::Section.new('The list + composer') do
            render Views::Code.new(<<~RUBY, lexer: :ruby)
        ...
        def what_you_get
          render Views::Docs::Section.new('What you get') do
            render Views::Docs::Prose.new do
              ul do
                li do
        ...
        def keyed_lists
          render Views::Docs::Section.new('Keyed lists & morphing') do
            render Views::Docs::Prose.new do
              p do
            ...
            render Views::Docs::Callout.new(:warning, title: 'Don’t render list items without a stable id') do
