...
module Views
  module Docs
    module Pages
      class ExampleInlineEdit < Views::Docs::Page
        ...
        def the_component
          render Views::Docs::Section.new('The component') do
            ...
            render Views::Code.new(<<~RUBY, lexer: :ruby, filename: 'app/components/fields/inline_edit.rb')
        ...
        def rendering
          render Views::Docs::Section.new('Render it for any field') do
        ...
        def validation_error
          render Views::Docs::Section.new('Surfacing a validation error') do
            render Views::Docs::Prose.new do
              p do
                code { 'save' }
                plain ' above uses '
        ...
        def live_as_you_type
          render Views::Docs::Section.new('Live-as-you-type (a spreadsheet-like grid)') do
            render Views::Docs::Prose.new do
              p do
        ...
        def broadcasting
          render Views::Docs::Section.new('Want it to update other viewers too?') do
            render Views::Docs::Prose.new do
