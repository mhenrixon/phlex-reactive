  ...
  module Docs
    module Pages
      class Architecture < ::Docs::Page
        ...
        def mental_model
          render ::Docs::Section.new('The mental model') do
        ...
        def layers
          render ::Docs::Section.new('The layers') do
            render ::Docs::Prose.new do
              ul do
        ...
        def identity
          render ::Docs::Section.new('Signed identity, not state') do
            render ::Docs::Prose.new do
              p do
            ...
            render ::Docs::Callout.new(:warning, title: 'Never trust client input') do
