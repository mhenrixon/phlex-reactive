...
module Views
  module Docs
    module Pages
      class ExampleCollections < Views::Docs::Page
        ...
        def intro
          render Views::Docs::Section.new('Example: reactive collections (add/remove rows + count + empty-state)') do
        ...
        def declare_collection
          render Views::Docs::Section.new('Declare the collection on the container') do
            render Views::Code.new(<<~RUBY, lexer: :ruby, filename: 'app/components/notifications_list.rb')
        ...
        def row_and_empty
          render Views::Docs::Section.new('The row and empty-state components') do
            render Views::Docs::Prose.new do
              p do
            ...
            render Views::Code.new(<<~RUBY, lexer: :ruby, filename: 'app/components/notification_row.rb')
        ...
        def what_each_reply_emits
          render Views::Docs::Section.new('What each reply emits') do
            render Views::Docs::Prose.new do
              ul do
                li do
        ...
        def why_count_right
          render Views::Docs::Section.new('Why the count is always right') do
            render Views::Docs::Prose.new do
              p do
                code { 'size:' }
                plain ' is '
        ...
        def repeated_add_remove
          render Views::Docs::Section.new("Repeated add/remove: the container's token rolls forward") do
            render Views::Docs::Prose.new do
              p do
                code { 'reply.append' }
                plain ' / '
        ...
        def cross_tab
          render Views::Docs::Section.new('Cross-tab: keep broadcasting the row') do
            render Views::Docs::Prose.new do
              p do
                code { 'reactive_collection' }
                plain ' governs the '
        ...
        def related
          render Views::Docs::Section.new('Related') do
            render Views::Docs::Prose.new do
              ul do
                li do
