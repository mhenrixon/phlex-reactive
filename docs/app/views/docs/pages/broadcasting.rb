...
module Views
  module Docs
    module Pages
      class Broadcasting < Views::Docs::Page
        ...
        def pattern
          render Views::Docs::Section.new('The pattern') do
        ...
        def stream_keys
          render Views::Docs::Section.new('Stream keys: pass raw parts, not a built key') do
            render Views::Docs::Prose.new do
              p do
        ...
        def methods_table
          render Views::Docs::Section.new('The broadcast methods') do
            render Views::Docs::Prose.new do
              ul do
                li do
        ...
        def model_mapping
          render Views::Docs::Section.new('How model: maps to the init keyword') do
            render Views::Docs::Prose.new do
              p do
        ...
        def from_action
          render Views::Docs::Section.new('Broadcasting from inside a reactive action') do
            render Views::Docs::Prose.new do
              p do
        ...
        def actor_echo
          render Views::Docs::Section.new('Actor-echo suppression (exclude:)') do
            render Views::Docs::Prose.new do
              p do
        ...
        def transactional
          render Views::Docs::Section.new('Transactional broadcasts (with pgbus)') do
            render Views::Docs::Prose.new do
              p do
        ...
        def removing_actor
          render Views::Docs::Section.new("Removing the actor's own element") do
            render Views::Docs::Prose.new do
              p do
                code { 'destroy' }
        ...
        def presence
          render Views::Docs::Section.new('Presence (who\'s here / typing)') do
            render Views::Docs::Prose.new do
              p do
