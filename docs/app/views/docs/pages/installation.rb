  ...
  module Docs
    module Pages
      class Installation < ::Docs::Page
        ...
        def install
          render ::Docs::Section.new('Install') do
            render ::Docs::Code.new(<<~RUBY, lexer: :ruby, filename: 'Gemfile')
              gem "phlex-reactive"
            RUBY
        ...
        def generators
          render ::Docs::Section.new('Generators') do
            render ::Docs::Code.new(<<~SHELL, lexer: :shell)
              # Setup (idempotent)
              bin/rails generate phlex:reactive:install
        ...
        def importmap
          render ::Docs::Section.new('importmap-rails (default Rails 7+)') do
            render ::Docs::Code.new(<<~JS, lexer: :javascript, filename: 'app/javascript/controllers/index.js')
              import { application } from "controllers/application"
              import ReactiveController from "phlex/reactive/reactive_controller"
              application.register("reactive", ReactiveController)
            JS
            render ::Docs::Callout.new(:warning, title: 'Register eagerly, not lazily') do
              plain 'If you '
        ...
        def jsbundling
          render ::Docs::Section.new('esbuild / rollup / webpack (jsbundling)') do
            render ::Docs::Code.new(<<~JS, lexer: :javascript, filename: 'app/javascript/controllers/index.js')
        ...
        def bun
          render ::Docs::Section.new('bun (bun-rails)') do
            render ::Docs::Prose.new do
              p do
        ...
        def requirements
          render ::Docs::Section.new('Requirements') do
            render ::Docs::Prose.new do
              ul do
                li do
                  strong { 'Rails' }
        ...
        def configuration
          render ::Docs::Section.new('Configuration') do
            render ::Docs::Prose.new do
              p do
                plain 'Create '
                code { 'config/initializers/phlex_reactive.rb' }
            ...
            render ::Docs::Code.new(<<~ERB, lexer: :erb)
        ...
        def verify
          render ::Docs::Section.new('Verify it works') do
            render ::Docs::Prose.new do
              p do
